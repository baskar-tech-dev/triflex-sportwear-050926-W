    ...
    <div class="container">
      <div class="header-inner">
        ...
        <div class="header-right-actions">
          ...
          <button type="button" class="mobile-menu-toggle" id="drawer-open-btn" aria-label="Open mobile menu" aria-expanded="false" aria-controls="mobile-drawer">
...
function getModalsAndDrawersHTML(activePage = '') {
  return `
  ...
  <aside class="enquiry-drawer" id="mobile-drawer" role="dialog" aria-label="Mobile Navigation Menu">
    ...
    <div class="drawer-body">
      ...
      <a href="collection.html" class="mobile-nav-link ${activePage === 'collection' ? 'active' : ''}">
        <span class="nav-link-main">
      ...
      <a href="men.html" class="mobile-nav-link ${activePage === 'men' ? 'active' : ''}">
        <span class="nav-link-main">
      ...
      <a href="women.html" class="mobile-nav-link ${activePage === 'women' ? 'active' : ''}">
        <span class="nav-link-main">
      ...
      <a href="kids.html" class="mobile-nav-link ${activePage === 'kids' ? 'active' : ''}">
        <span class="nav-link-main">
      ...
      <a href="teamwear.html" class="mobile-nav-link ${activePage === 'teamwear' ? 'active' : ''}">
        <span class="nav-link-main">
      ...
      <a href="wholesale.html" class="mobile-nav-link ${activePage === 'solutions' || activePage === 'wholesale' ? 'active' : ''}">
        <span class="nav-link-main">
      ...
      <a href="private-label.html" class="mobile-nav-link ${activePage === 'private-label' ? 'active' : ''}">
        <span class="nav-link-main">
      ...
      <a href="manufacturing.html" class="mobile-nav-link ${activePage === 'manufacturing' ? 'active' : ''}">
        <span class="nav-link-main">
